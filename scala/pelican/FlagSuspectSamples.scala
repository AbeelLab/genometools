...
object FlagSuspectSamples extends Main {
  ...
  override def main(args: Array[String]): Unit = {
    ...
    //    extract(594,null,new File("v:/TB-ARC/development/drugs.test.zhang.txt"),true,true,new File("C:/Users/tabeel/workspace/TB-ARC - Zoo/pelican/zhang.mapping.txt"),true);
    //    extract(481, null, new File("c:/tabeel/local_KRITH_extended/drugs.test.krith.txt"), true, false, null, false);
